...
-- Remove foreign key constraint to allow any pack_id
-- This allows the form to work even if the pack_id doesn't exist in webster_packs table
-- ALTER TABLE public.pack_checks
--    ADD CONSTRAINT pack_checks_pack_id_fkey
--    FOREIGN KEY (pack_id)
--    REFERENCES public.webster_packs(id)
--    ON DELETE CASCADE;
